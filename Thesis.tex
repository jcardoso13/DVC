...
\input{Thesis_Deep_Versat}
%\input{Thesis_Implementation} % file "Thesis_Implementation.tex"
\cleardoublepage

\input{Thesis_CNN_Versat} % add new .tex files for new chapters
\cleardoublepage



%\input{Thesis_Work} % add new .tex files for new chapters
%\cleardoublepage

% YoloLITE
\input{Thesis_YoloLITE} % add new .tex files for new chapters
\cleardoublepage

% Configuration Files to Darknet
\input{Thesis_CFG} % add new .tex files for new chapters
\cleardoublepage


% Deep Versat Simulator
\input{Thesis_Simulator} % add new .tex files for new chapters
\cleardoublepage



% Automatic Convolution Configuration Writer
\input{Thesis_Configuration} % add new .tex files for new chapters
\cleardoublepage
